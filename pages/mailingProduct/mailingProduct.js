...
/// <reference path="~/www/pages/mailingProduct/mailingProductController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("mailingProduct");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new MailingProduct.Controller(element, commandList);
