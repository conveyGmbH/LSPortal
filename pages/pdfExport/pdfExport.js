...
(function () {
    ...
    var pageName = Application.getPagePath("pdfExport");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickExportPDF", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.new"), section: "primary", svg: "folder_out" },
            ];
