...
/// <reference path="~/www/pages/eventSpeakerAdministration/eventSpeakerAdministrationController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.eventSpeakerAdministrationLayout", {
        EventSpeakerLayout: WinJS.Class.define(function (options) {
                this._site = null;
                this._surface = null;
            },
            {
    ...
    var pageName = Application.getPagePath("eventSpeakerAdministration");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new EventSpeakerAdministration.Controller(element, commandList);
