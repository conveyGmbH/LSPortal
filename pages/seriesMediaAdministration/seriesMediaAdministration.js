...
/// <reference path="~/www/pages/seriesMediaAdministration/seriesMediaAdministrationController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("seriesMediaAdministration");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new SeriesMediaAdministration.Controller(element, commandList);
