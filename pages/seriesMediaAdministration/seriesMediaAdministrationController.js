// controller for page: seriesMediaAdministration
...
/// <reference path="~/www/pages/seriesMediaAdministration/seriesMediaAdministrationService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("SeriesMediaAdministration", {
        ...
        Controller: WinJS.Class.derive(Application.Controller, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.");
            var that = this;
            ...
            var setDocCount = function (count) {
                Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.", "count=" + count);
                if (count > 1) {
            ...
            var setFlagInsert = function (flagInsert) {
                Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.", "flagInsert=" + flagInsert);
            ...
            var setAddIndex = function (addIndex) {
                Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.", "addIndex=" + addIndex);
            ...
            var getDocViewer = function (docGroup, docFormat) {
                var docViewer;
                Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.", "docGroup=" + docGroup + " docFormat=" + docFormat);
            ...
            var loadDoc = function (docId, docGroup, docFormat) {
                var ret = null;
                var parentElement;
                Log.call(Log.l.trace, "SeriesMediaAdministration.Controller.", "docId=" + docId + " docGroup=" + docGroup + " docFormat=" + docFormat);
            ...
            var loadList = function (docId) {
                Log.call(Log.l.trace, "SeriesMediaAdministration.", "docId=" + docId);
                var ret = null;
                ...
                if (mediaListFragmentControl && mediaListFragmentControl.controller) {
                    ret = mediaListFragmentControl.controller.loadData(docId, {
                        eventTextUsageId: SeriesMediaAdministration._eventTextUsageId,
            ...
            var deleteData = function () {
                ...
                var ret = new WinJS.Promise.as().then(function () {
                    AppBar.busy = true;
                    return SeriesMediaAdministration.mediaTable.deleteRecord(function (json) {
                        AppBar.busy = false;
            ...
            if (master && master.controller && master.controller.binding && master.controller.binding.seriesId) {
                that.setEventSeriesId(master.controller.binding.seriesId);
            }
