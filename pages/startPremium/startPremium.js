...
/// <reference path="~/www/pages/startPremium/startPremiumController.js" />
...
(function () {
    ...
    var pageName = Application.getPagePath("startPremium");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new StartPremium.Controller(element, commandList);
