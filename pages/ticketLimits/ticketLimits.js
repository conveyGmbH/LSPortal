...
/// <reference path="~/www/pages/ticketLimits/ticketLimitsController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("ticketLimits");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new TicketLimits.Controller(element, commandList);
