...
(function () {
    ...
    WinJS.Namespace.define("Application.ClientManagementListLayout", {
    ...
    var pageName = Application.getPagePath("clientManagementList");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new ClientManagementList.Controller(element, commandList, isMaster);
            Log.ret(Log.l.trace);
        },
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var clientManagementList = element.querySelector("#clientManagementList.listview");
                    if (clientManagementList && clientManagementList.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                clientManagementList.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                clientManagementList.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
