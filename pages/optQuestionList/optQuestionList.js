...
/// <reference path="~/www/pages/optQuestionList/optQuestionListController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.OptQuestionListLayout", {
    ...
    var pageName = Application.getPagePath("optQuestionList");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newOpQuestionList"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteOpQuestionList"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new OptQuestionList.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var questiongroup = element.querySelector("#optQuestionList.listview");
