...
/// <reference path="~/www/pages/dashboardFN/dashboardFNController.js" />

(function () {
    "use strict";
    WinJS.Namespace.define("Application.DashboardFNLayout", {
        DashboardFNLayout: WinJS.Class.define(function (options) {
                this._site = null;
                this._surface = null;
            },
            {
                ...
                initialize: function (site) {
                    ...
                    WinJS.Utilities.addClass(this._surface, "dashboardFNLayout");
                ...
                uninitialize: function () {
                    WinJS.Utilities.removeClass(this._surface, "dashboardFNLayout");
                    this._site = null;
                    this._surface = null;
                }
            })
    });
    var pageName = Application.getPagePath("dashboardFN");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new DashboardFN.Controller(element, commandList);
