// controller for page: dashboardFN
...
/// <reference path="~/www/pages/dashboardFN/dashboardFNService.js" />
            ...
            var loadData = function () {
                ...
                var ret = new WinJS.Promise.as().then(function () {
                    ...
                    if (diaCountrysFragmentControl && diaCountrysFragmentControl.controller) {
                        ...
                        if (parentElement) {
                            return Application.loadFragmentById(parentElement, "dashboardFNCountry", {});
                        } else {
                    ...
                    if (diaYearRangeFragmentControl && diaYearRangeFragmentControl.controller) {
                        ...
                        if (parentElement) {
                            return Application.loadFragmentById(parentElement, "dashboardFNDay", {});
                        } else {
                            return WinJS.Promise.as();
                        }
                    }
                }).then(function () {
                    var diaVisitorsFragmentControl = Application.navigator.getFragmentControlFromLocation(Application.getFragmentPath("dashboardFNHour"));
                    if (diaVisitorsFragmentControl && diaVisitorsFragmentControl.controller) {
                        ...
                        if (parentElement) {
                            return Application.loadFragmentById(parentElement, "dashboardFNHour", {});
                        } else {
                            return WinJS.Promise.as();
                        }
                    }
                }).then(function () {
                    var diaCountrysIndustriespDFragmentControl = Application.navigator.getFragmentControlFromLocation(Application.getFragmentPath("dashboardFNTop10"));
                    if (diaCountrysIndustriespDFragmentControl && diaCountrysIndustriespDFragmentControl.controller) {
                        ...
                        if (parentElement) {
                            return Application.loadFragmentById(parentElement, "dashboardFNTop10", {});
                        } else {
                            return WinJS.Promise.as();
                        }
                    }
                }).then(function () {
                    var diaIndustriespDFragmentControl = Application.navigator.getFragmentControlFromLocation(Application.getFragmentPath("dashboardFNIndustries"));
                    if (diaIndustriespDFragmentControl && diaIndustriespDFragmentControl.controller) {
                        ...
                        if (parentElement) {
                            return Application.loadFragmentById(parentElement, "dashboardFNIndustries", {});
                        } else {
                            return WinJS.Promise.as();
                        }
                    }
                ...
                exportBrowserViewToPdf: function (event) {
                    ...
                    var ret = new WinJS.Promise.as().then(function () {
                        ...
                        return html2canvas(element, {
                            ...
                            if (that.isSupreme === 4) {
                                statusText = getResourceText("label.dashboardFNSupreme");
                                doc.save(getResourceText("label.dashboardFNSupreme"), { returnPromise: true });
                            } else {
                                statusText = getResourceText("label.dashboardFNPremium");
                                doc.save(getResourceText("label.dashboardFNPremium"), { returnPromise: true });
                            }
                        });
                    }).then(function () {
                        that.binding.progress = {
