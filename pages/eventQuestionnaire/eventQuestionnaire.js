...
/// <reference path="~/www/pages/eventQuestionnaire/eventQuestionnaireController.js" />
...
(function () {
        ...
        EventQuestionnaireLayout: WinJS.Class.define(function (options) {
            ...
            },
            {
                ...
                initialize: function (site) {
                    ...
                    WinJS.Utilities.addClass(this._surface, "eventQuestionnaireLayout");
                ...
                uninitialize: function () {
                    WinJS.Utilities.removeClass(this._surface, "eventQuestionnaireLayout");
                    this._site = null;
                    this._surface = null;
                }
            })
    ...
    var pageName = Application.getPagePath("eventQuestionnaire");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new EventQuestionnaire.Controller(element, commandList);
