...
/// <reference path="~/www/pages/visitorFlowEntExt/visitorFlowEntExtController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.VisitorFlowEntExtLayout", {
        VisitorFlowEntExtLayout: WinJS.Class.define(function (options) {
            this._site = null;
            this._surface = null;
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "visitorflowentextLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "visitorflowentextLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("visitorFlowEntExt");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new VisitorFlowEntExt.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var visitorflowentext = element.querySelector("#visitorflowentext.listview");
                    if (visitorflowentext && visitorflowentext.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                visitorflowentext.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                visitorflowentext.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
