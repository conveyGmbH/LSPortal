...
/// <reference path="~/www/pages/visitorFlowDashboard/visitorFlowDashboardController.js" />

(function () {
    "use strict";
    WinJS.Namespace.define("Application.VisitorFlowDashboardLayout", {
        VisitorFlowDashboardLayout: WinJS.Class.define(function (options) {
                this._site = null;
                this._surface = null;
            },
            {
                ...
                initialize: function (site) {
                    ...
                    WinJS.Utilities.addClass(this._surface, "visitorFlowDashboardLayout");
                ...
                uninitialize: function () {
                    WinJS.Utilities.removeClass(this._surface, "visitorFlowDashboardLayout");
                    this._site = null;
                    this._surface = null;
                }
            })
    });
    var pageName = Application.getPagePath("visitorFlowDashboard");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new VisitorFlowDashboard.Controller(element, commandList);
