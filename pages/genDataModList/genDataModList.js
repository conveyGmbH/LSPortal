...
/// <reference path="~/www/pages/genDataModList/genDataModListController.js" />
(function () {
    "use strict";

    WinJS.Namespace.define("Application.GenDataModListLayout", {
        GenDataModListLayout: WinJS.Class.define(function (options) {
            this._site = null;
            this._surface = null;
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "genDataModListLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "genDataModListLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("genDataModList");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new GenDataModList.Controller(element, commandList, isMaster);
            Log.ret(Log.l.trace);
        },
