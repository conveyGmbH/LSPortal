...
/// <reference path="~/www/pages/genDataSkillEntry/genDataSkillEntryController.js" />
...
(function () {
    ...
    var pageName = Application.getPagePath("genDataSkillEntry");
    //var inResize = 0;
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new GenDataSkillEntry.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    ...
                    var listQuestionnaire = element.querySelector("#genDataSkillEntryList.listview");
