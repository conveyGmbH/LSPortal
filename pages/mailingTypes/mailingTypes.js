...
/// <reference path="~/www/pages/mailingTypes/mailingTypesController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("mailingTypes");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new MailingTypes.Controller(element, commandList);
