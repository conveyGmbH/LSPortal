...
/// <reference path="~/www/pages/optMandatoryFieldList/optMandatoryFieldListController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.OptMandatoryFieldListLayout", {
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var questiongroup = element.querySelector("#optMandatoryFieldList.listview");
