...
/// <reference path="~/www/pages/contactResultsList/contactResultsListController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.ContactResultsListLayout", {
        ContactResultsListLayout: WinJS.Class.define(function (options) {
                this._site = null;
                this._surface = null;
            },
            {
                ...
                initialize: function (site) {
                    ...
                    WinJS.Utilities.addClass(this._surface, "contactResultsListLayout");
                    return WinJS.UI.Orientation.vertical;
                },

                // Reset the layout to its initial state
                uninitialize: function () {
                    WinJS.Utilities.removeClass(this._surface, "contactResultsListLayout");
                    this._site = null;
                    this._surface = null;
                }
            })
    ...
    var pageName = Application.getPagePath("contactResultsList");
