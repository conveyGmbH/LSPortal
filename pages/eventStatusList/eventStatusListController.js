...
/// <reference path="~/www/pages/eventStatusList/eventStatusListService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("EventStatusList", {
        Controller: WinJS.Class.derive(Application.Controller, function Controller(pageElement, commandList, isMaster) {
            ...
            // ListView control
            var listView = pageElement.querySelector("#eventstatuslist.listview");
            var progress = null;
            var counter = null;
            var layout = null;
            ...
            var loadNextUrl = function () {
                ...
                if (that.records && that.nextUrl && listView) {
                    ...
                    Log.print(Log.l.trace, "calling select EventStatusList.VeranstaltungView...");
                    var nextUrl = that.nextUrl;
                    that.nextUrl = null;
                    EventStatusList.VeranstaltungView.selectNext(function (json) { //json is undefined
                        // this callback will be called asynchronously
                        // when the response is available
                        Log.print(Log.l.trace, "EventStatusList.VeranstaltungView: success!");
                        // startContact returns object already parsed from json file in response
                        if (json && json.d && json.d.results && that.records) {
                            that.nextUrl = EventStatusList.VeranstaltungView.getNextUrl(json);
            ...
            var selectRecordId = function (recordId) {
                Log.call(Log.l.trace, "EventStatusList.Controller.", "recordId=" + recordId);
                                        ...
                                        if (newRecId !== 0 && newRecId !== that.curRecId) {
                                            ...
                                            if (AppBar.scope && typeof AppBar.scope.saveData === "function") {
                                                ...
                                                AppBar.scope.saveData(function (response) {
                                                    ...
                                                    if ((curPageId === "eventStatus") &&
                                                        typeof AppBar.scope.SessionEventId === "function") {
            ...
            var loadData = function () {
                ...
                var ret = new WinJS.Promise.as().then(function () {
                    return EventStatusList.VeranstaltungView.select(function (json) {
                        // this callback will be called asynchronously
                        // when the response is available
                        AppData.setErrorMsg(that.binding);
