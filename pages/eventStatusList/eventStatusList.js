...
/// <reference path="~/www/pages/eventStatusList/eventStatusListController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.EventStatusListLayout", {
        EventStatusListLayout: WinJS.Class.define(function (options) {
            this._site = null;
            this._surface = null;
        }, {
    ...
    var pageName = Application.getPagePath("eventStatusList");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new EventStatusList.Controller(element, commandList, isMaster);
            Log.ret(Log.l.trace);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var contactList = element.querySelector("#eventstatuslist.listview");
