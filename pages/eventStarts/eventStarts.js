...
/// <reference path="~/www/pages/eventStarts/eventStartsController.js" />
...
(function () {
    ...
    var pageName = Application.getPagePath("eventStarts");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new EventStarts.Controller(element, commandList);
