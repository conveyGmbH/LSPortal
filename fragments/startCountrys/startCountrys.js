...
/// <reference path="~/www/fragments/startCountrys/startCountrysController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("startCountrys");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new StartCountrys.Controller(element, options);
