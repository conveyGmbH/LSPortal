...
(function () {
    ...
    WinJS.Namespace.define("MailingProductLine.ListLayout", {
        MailingProductLineLayout: WinJS.Class.define(function (options) {
            ...
            },
            {
                ...
                initialize: function (site) {
                    ...
                    WinJS.Utilities.addClass(this._surface, "mailingProductLineLayout");
                ...
                uninitialize: function () {
                    WinJS.Utilities.removeClass(this._surface, "mailingProductLineLayout");
                    this._site = null;
                    this._surface = null;
                }
            })
    ...
    var fragmentName = Application.getFragmentPath("mailingProductLine");
