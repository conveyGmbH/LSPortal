...
/// <reference path="~/www/fragments/startNoData/startNoDataController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("startNoData");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new StartNoData.Controller(element, options);
