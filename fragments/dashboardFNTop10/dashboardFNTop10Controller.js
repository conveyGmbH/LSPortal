...
/// <reference path="~/www/fragments/dashboardFNTop10/dashboardFNTop10Service.js" />
            ...
            function Controller(fragmentElement, options) {
                ...
                var loadData = function () {
                    ...
                    var ret = new WinJS.Promise.as().then(function () {
                        ...
                        return DashboardFNTop10.veranstaltungView.select(function (json) {
                            Log.print(Log.l.trace, "reportLand: success!");
                            if (json && json.d && json.d.results && json.d.results.length > 0) {
                                var results = json.d.results;
                                results.forEach(function (item, index) {
                        ...
                        return DashboardFNTop10.mitarbeiterView.select(function (json) {
