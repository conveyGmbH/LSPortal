    ...
    WinJS.Namespace.define("DiaVisitors", {
        Controller: WinJS.Class.derive(Fragments.Controller, function Controller(fragmentElement, options) {
            ...
            var getEventId = function () {
                return DiaVisitors._eventId;
            }
            that.getEventId = getEventId;

            var setEventId = function (value) {
                Log.print(Log.l.trace, "eventId=" + value);
                DiaVisitors._eventId = AppBar.scope.getEventId();
            }
            ...
            var visitorTooltip = fragmentElement.querySelector("#mydiaVisitorElement2"); 
            ...
            var setTooltipText = function () {
                if (that.isSupreme === 1) {
                    visitorTooltip.innerHTML = getResourceText("diaVisitors.tooltipPremium");
                } else {
                    visitorTooltip.innerHTML = getResourceText("diaVisitors.tooltipSupreme1");
                }
            }
            ...
            var getGetDashboardVisitorData = function (interval, startday, endday) {
                ...
                var ret = AppData.call("PRC_GetDashTimeline", {
                    ...
                    Log.print(Log.l.info, "call PRC_GetDashTimeline success! ");
