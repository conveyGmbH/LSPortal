...
/// <reference path="~/www/fragments/diaVisitors/diaVisitorsController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("diaVisitors");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new DiaVisitors.Controller(element, options);
