...
/// <reference path="~/www/fragments/svgMedia/svgMediaService.js" />
/// <reference path="~/www/fragments/svgMedia/svgeditor.js" />
    ...
    WinJS.Namespace.define(namespaceName, {
        Controller: WinJS.Class.derive(Fragments.Controller, function Controller(fragmentElement, options, commandList) {
            ...
            var loadData = function (noteId) {
                ...
                if (noteId) {
                    ret = SvgMedia.sketchDocView.select(function (json) {
                        // this callback will be called asynchronously
                        // when the response is available
                        Log.print(Log.l.trace, "SvgMedia.sketchDocView: success!");
                        ...
                        if (that.svgEditor) {
                            that.svgEditor.fnSaveSVG(function(quelltext) {
                                ...
                                if (that.binding.noteId) {
                                    doret = SvgMedia.sketchView.update(function(response) {
                                            var doret2;
                                            // called asynchronously if ok
                                    ...
                                    if (!dataSketch.KontaktID) {
                                        ...
                                        doret = SvgMedia.sketchView.insert(function(json) {
                                                var doret2;
                                                // this callback will be called asynchronously
                                                // when the response is available
            ...
            var deleteData = function() {
                ...
                var ret = WinJS.Promise.as().then(function () {
                    if (options && options.isLocal) {
                        ...
                        return SvgMedia.sketchView.deleteRecord(function(response) {
                            // called asynchronously if ok
