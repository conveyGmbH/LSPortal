...
(function () {
    ...
    WinJS.Namespace.define("VideoMedia", {
        Controller: WinJS.Class.derive(Fragments.Controller, function Controller(fragmentElement, options, commandList) {
            Log.call(Log.l.trace, "VideoMedia.Controller.", "noteId=" + (options && options.noteId));
            ...
            var insertAudiodata = function (audioData, fileExt) {
                var ovwEdge = 256;
                var err = null;
                Log.call(Log.l.trace, "VideoMedia.Controller.", "fileExt=" + fileExt);
            ...
            var loadDataFile = function (dataDirectory, fileName, bUseRootDir) {
                var fileExt;
                var filePath;
                Log.call(Log.l.trace, "VideoMedia.Controller.", "dataDirectory=" + dataDirectory + " fileName=" + fileName + " bUseRootDir=" + bUseRootDir);
            ...
            var onCaptureFail = function (errorMessage) {
                Log.call(Log.l.error, "VideoMedia.Controller.");
                var audioRecorderContainer = fragmentElement.querySelector(".audio-recorder-container");
                if (audioRecorderContainer && audioRecorderContainer.style) {
                    audioRecorderContainer.style.display = "";
                }
            ...
            var deleteData = function () {
                ...
                var ret = WinJS.Promise.as().then(function () {
                    if (options && options.isLocal) {
                        return VideoMedia.sketchView.deleteRecord(function (response) {
