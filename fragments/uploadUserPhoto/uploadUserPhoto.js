...
/// <reference path="~/www/fragments/uploadUserPhoto/uploadUserPhotoController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("uploadUserPhoto");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new UploadUserPhoto.Controller(element, options, commandList);
