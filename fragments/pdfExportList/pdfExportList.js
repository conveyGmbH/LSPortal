...
(function () {
    ...
    var fragmentName = Application.getFragmentPath("PdfExportList");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new PdfExportList.Controller(element, options);
       ...
       updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var empList = element.querySelector("#pdfExportList.listview");
