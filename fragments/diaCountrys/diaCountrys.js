...
/// <reference path="~/www/fragments/diaCountrys/diaCountrysController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("diaCountrys");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new DiaCountrys.Controller(element, options);
