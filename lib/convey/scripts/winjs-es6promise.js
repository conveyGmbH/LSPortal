...
(function () {
    ...
    WinJS.Utilities._require([
        ...
        _Global.toES6Promise = function (winjsPromise) {
            ...
            var value;
            if (!winjsPromise || !(typeof winjsPromise.then === "function")) {
                var callerValue = winjsPromise;
                winjsPromise = WinJS.Promise.wrap(callerValue);
            }
        ...
        _Global.toWinJSPromise = function (es6Promise) {
            var ret;
            Log.call(Log.l.trace);
            if (es6Promise && typeof es6Promise.then === "function") {
                ...
                ret = WinJS.Promise.wrap(es6Promise);
            }
            Log.ret(Log.l.trace);
            return ret;
        };
