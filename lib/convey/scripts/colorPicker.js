...
(function () {
    ...
    WinJS.Namespace.define("ColorPicker", {
        ...
        ColorPickerClass: WinJS.Class.define(
            ...
            function ColorPickerClass(colorpicker, size, px, color, setter) {
                Log.call(Log.l.trace, "ColorPicker.", "id=" + colorpicker.id + " size=" + size + " px=" + px + " color=" + color);
                ...
                // create div inside parent colorpicker to trigger popup of actual color picker
                var cpTrigger = document.createElement("div");
                cpTrigger.id = colorpicker.id;
                ...
                colorpicker.appendChild(cpTrigger);
                ...
                for (var i = 0; i < size; i++) {
                    ...
                    for (var j = 0; j < size2; j++) {
                        var id = colorpicker.id + "_color_" + i.toString() + "_" + j.toString();
                ...
                colorcontainer.id = colorpicker.id;
