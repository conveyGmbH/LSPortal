            ...
            function PageControlNavigator(element, options) {
                ...
                resizeSplitView: function () {
                    ...
                    if (splitViewRoot && splitViewContent) {
                        ...
                        /*
                        var splitViewPane = this.splitViewPane;
                        if (AppBar.commandList && AppBar.commandList.length > 0 &&
                            ...
                            if (AppBar.barControl && AppBar.barControl.placement === "top") {
                                AppBar.barElement.style.width = splitViewContent.clientWidth + "px";
                                AppBar.barElement.style.marginLeft = splitViewPane.clientWidth + "px";
                                splitViewContent.style.marginTop = AppBar.barElement.clientHeight + "px";
                            } else {
                                AppBar.barElement.style.width = "";
                                AppBar.barElement.style.marginLeft = "";
                                splitViewContent.style.marginTop = "0";
                            }
                        } else {
                            AppBar.barElement.style.width = "";
                            AppBar.barElement.style.marginLeft = "";
                ...
                resizePageElement: function (element) {
                    ...
                    if (element && element.style && splitViewContent) {
                        ...
                        if (navBarVisible) {
                            ...
                            // hide page top line - now in accent color!
                            if (AppBar.barControl && AppBar.barControl.placement === "bottom" ||
                                !AppBar._commandList || !AppBar._commandList.length ||
                                AppBar.barControl && AppBar.barControl.disabled) {
                                top -= 2;
                                height += 2;
                            }
                        }
