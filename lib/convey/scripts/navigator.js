            ...
            function ListViewClass(navigationBarPages, navigationBarGroups, options) {
                ...
                if (!NavigationBar._listViewVert) {
                    if (!NavigationBar._listViewHorz) {
                        ...
                        Colors.changeCSS(".navigationbar-container-horizontal", "height", AppData.persistentStatesDefaults.navHorzHeight.toString() + "px");
                    } else {
                        listOrientation = "vertical";
                        Colors.changeCSS(".navigationbar-container-vertical", "width", AppData.persistentStatesDefaults.navVertWidth.toString() + "px");
