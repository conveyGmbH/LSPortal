...
(function () {
    ...
    WinJS.Namespace.define("Application", {
        ...
        showDetail: function () {
            if (Application.navigator && Application.navigator._nextMaster && Application.navigator._masterMaximized) {
                ...
                _hideMaster: function() {
                    ...
                    if (!this._masterHidden) {
                        ...
                        if (this.pageElement) {
                            ...
                            var animationDistanceX = this.masterElement.clientWidth;
                ...
                _showMaster: function () {
                    ...
                    if (this._masterHidden) {
                        ...
                        if (this.masterElement) {
                            this.resizeMasterElement(this.masterElement);
                            this.masterElement.style.visibility = "";
                        }
                        if (this.pageElement) {
                            var animationDistanceX = this.masterElement.clientWidth;
