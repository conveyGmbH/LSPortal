...
(function () {
    ...
    WinJS.Namespace.define("Application", {
        ...
        navigateById: function(id, event, removeBackStack) {
            ...
            var ret = WinJS.Promise.timeout(0)
                .then(function() {
    ...
    WinJS.Namespace.define("NavigationBar", {
        ...
        createViewPaneSubMenu: function (group, element, title) {
            ...
            if (subMenuFlyout &&
                ...
                if (!subMenuFlyout._handleBlur) {
                    subMenuFlyout._handleBlur = function (ev) {
                        var activeElement = document.activeElement;
                        if (!subMenuList.winControl._canvas.contains(activeElement)) {
                    ...
                    subMenuFlyout.addEventListener("blur", subMenuFlyout._handleBlur);
                }
                WinJS.UI.Animation.slideRightIn(subMenuFlyout).done(function () {
                    subMenuFlyout.focus();
                });
            }
            Log.ret(Log.l.trace, "");
        ...
        handleSubmenuLoadingStateChanged: function(ev) {
            Log.call(Log.l.trace, "NavigationBar.");
            var subMenuList = Application.navigator && Application.navigator.subMenuList;
            if (subMenuList && subMenuList.winControl) {
