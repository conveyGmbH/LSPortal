            ...
            function PageControlNavigator(element, options) {
                ...
                _beforeload: function (id) {
                    ...
                    if (fragment._beforeLoadPromise &&
                        ...
                        if (fragment._beforeLoadPromise._watchdog &&
                            typeof fragment._beforeLoadPromise._watchdog.cancel === "function") {
                            Log.print(Log.l.trace, "cancel beforeLoadPromise-watchdog of fragments[" + id + "]");
                            fragment._beforeLoadPromise._watchdog.cancel();
                            fragment._beforeLoadPromise._watchdog = null;
                        }
                    ...
                    if (fragment._element &&
                        ...
                        fragment._beforeLoadPromise = fragment._element.firstElementChild.winControl.canUnload(function (response) {
                            ...
                            var watchdog = WinJS.Promise.timeout(120000).then(function() {
                            ...
                            if (fragment._beforeLoadPromise) {
                                fragment._beforeLoadPromise._watchdog = watchdog;
                            }
                            return watchdog;
                        });
                    } else {
                ...
                _beforenavigate: function (args) {
                    ...
                    if (this._beforeNavigatePromise &&
                        ...
                        if (this._beforeNavigatePromise._watchdog &&
                            typeof this._beforeNavigatePromise._watchdog.cancel === "function") {
                            Log.print(Log.l.trace, "cancel beforeNavigatePromise-watchdog of page");
                            this._beforeNavigatePromise._watchdog.cancel();
                            this._beforeNavigatePromise._watchdog = null;
                        }
                        ...
                        var checkCanUnload = function () {
                            ...
                            if (!(pageId === "register" || (pageId === "account" && prevPageId === "login")) &&
                                ...
                                ret = that._element.firstElementChild.winControl.canUnload(function(response) {
                                    ...
                                    if (that._beforeNavigatePromise) {
                                        that._beforeNavigatePromise._watchdog = watchdog;
                                    }
                                    return watchdog;
                                });
                            } else {
                                ...
                                for (propertyName in prevFragments) {
                                    if (prevFragments.hasOwnProperty(propertyName)) {
                                        ...
                                        if (prevFragments[propertyName]._beforeLoadPromise) {
                                            ...
                                            if (prevFragments[propertyName]._beforeLoadPromise._watchdog) {
                                                if (typeof prevFragments[propertyName]._beforeLoadPromise._watchdog.cancel === "function") {
                                                    Log.print(Log.l.trace, "cancel beforeLoadPromise-watchdog of fragments[" + propertyName + "]");
                                                    prevFragments[propertyName]._beforeLoadPromise._watchdog.cancel();
                                                }
                                                prevFragments[propertyName]._beforeLoadPromise._watchdog = null;
                                            }
