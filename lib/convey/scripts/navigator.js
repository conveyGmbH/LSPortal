                 ...
                 this._events = [
                     ...
                     { 
                         ...
                         handler: function onMouseDown(eventInfo) {
                             Log.call(Log.l.trace, "ResizeHelper.");
                             if (!that._pointerCaptured && eventInfo && 
                                 that._gripper && that._gripper.style) {
                         ...
                         handler: function onPointerDown(eventInfo) {
                             ...
                             if (!that._pointerCaptured && eventInfo && 
                                 ...
                                 //        eventInfo.pageY <= position.top + position.height) {
                                         ...
                                         /*if (that._pointerType === "touch" && that._options) {
                                             if (that._options && options.vertical) {
                                                 that._gripper.style.height = "16px";
                                             } else {
                                                 that._gripper.style.width = "16px";
                                             }
                                         }*/
                                 //    }
                                 //}
                     ...
                     { 
                         name: ["pointerup", "pointercancel", "lostpointercapture"], handler: function onPointerUp(eventInfo) {
                             ...
                             if (that._pointerCaptured && eventInfo && 
                                 ...
                                 /*if (that._pointerType === "touch" && that._options) {
                                     if (that._options && options.vertical) {
                                         that._gripper.style.height = "6px";
                                     } else {
                                         that._gripper.style.width = "6px";
                                     }
                                 }*/
                             }
                             Log.ret(Log.l.trace);
