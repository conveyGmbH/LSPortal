            ...
            createHelpPane: function (result) {
                ...
                if (result && result.Title) {
                    ...
                    if (helpPane) {
                        ...
                        if (!helpPane._handleFocusIn &&
                            Application.navigator.splitViewRoot) {
                            ...
                            Application.navigator.splitViewRoot.addEventListener("focusin", helpPane._handleFocusIn);
                        }
                        ...
                        if (helpMediaContainer) {
                            if (!result.MediaURL) {
                                ...
                                helpMediaContainer.style.display = "";
                            }
                        }
                        var helpText = helpPane.querySelector(".help-text");
                        if (helpText && helpText.firstElementChild && helpText.parentElement) {
