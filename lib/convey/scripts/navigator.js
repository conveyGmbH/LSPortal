                                ...
                                if (element && listControl) {
                                    ...
                                    if (NavigationBar.ListView._listOrientation === "vertical") {
                                        ...
                                        if (listControl.loadingState === "complete") {
                                            ...
                                            containers = element.querySelectorAll(".win-container");
                                            if (containers && containers.length === NavigationBar.data.length) {
                                                var item, innerText, itemWidth;
                                                var totalWidth = 0;
                                                var maxWidth = 0;
                                                for (i = 0; i < containers.length; i++) {
                                                    container = containers[i];
                                                    if (container) {
                                                        innerText = container.querySelector(".navigationbar-inner-text");
                                                        itemWidth = 0;
                                                        if (innerText && innerText.offsetWidth > 0) {
                                                            itemWidth = innerText.offsetWidth;
                                                        } else {
                                                ...
                                                if (width < maxWidth * NavigationBar.data.length || !resizeItem) {
                                                    width = maxWidth * NavigationBar.data.length;
                                                    strWidth = width.toString() + "px";
                                                ...
                                                for (i = 0; i < containers.length; i++) {
                                                    ...
                                                    if (container) {
                                                        ...
                                                        if (itemWidth > 0) {
                                                            ...
                                                            if (totalWidth > 0) {
                                                                widthNavigationbarItem = Math.floor((width * itemWidth) / totalWidth);
                                                            } else {
                                                                widthNavigationbarItem = Math.floor(itemWidth);
                                                            }
