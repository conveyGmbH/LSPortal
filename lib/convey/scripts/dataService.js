...
(function () {
    ...
    WinJS.Namespace.define("AppData", {
        ...
        replaceSqlFilter: function(restriction) {
                ...
                for (var op in AppData._sqlFilterReplacement) {
                    if (AppData._sqlFilterReplacement.hasOwnProperty(op)) {
                        if (restriction.indexOf(op) === 0) {
                            sqlRestriction =
                                " " + AppData._sqlFilterReplacement[op] + " " + restriction.substr(op.length);
                            break;
                        }
                    }
                }
        ...
        replaceOdataFilter: function (restriction) {
            ...
            if (typeof restriction === "string") {
                ...
                if (!odataRestriction) {
                    odataRestriction = "%20eq%20'" + restriction + "'";
                }
            } else {
                odataRestriction = "%20eq%20" + restriction;
            }
                                        ...
                                        for (i = 0; i < that.attribSpecs.length; i++) {
                                            if (that.attribSpecs[i].Name) {
                                                ...
                                                if (typeof curRestriction !== "undefined" &&
                                                    ...
                                                    if (that.attribSpecs[i].AttribTypeID === 3 && !restriction.bExact) {
                                                        ...
                                                        if (typeof curRestriction === "object") {
                                                            if (restriction.bAndInEachRow) {
                                                                if (curRestriction.length > r) {
                                                                    ...
                                                                    if (curRestriction[r] === null) {
                                                                        ...
                                                                        curFilterString += that.attribSpecs[i].Name + AppData.replaceSqlFilter(curRestriction[r]);
                                                                    }
                                                                }
                                                            } else {
                                                                hasRestriction = false;
                                                            ...
                                                            if ((that.attribSpecs[i].Function & 16384) &&
                                                                ...
                                                                if (curRestriction === "NULL") {
                                                                    ...
                                                                    curFilterString += that.attribSpecs[i].Name + AppData.replaceSqlFilter(curRestriction);
                                                                }
                                                            }
                                                        }
                                                    }
                                                        ...
                                                        if (typeof curRestriction === "object") { //object
                                                            if (restriction.bAndInEachRow) {
                                                                if (curRestriction.length > r) {
                                                                    ...
                                                                    if (curRestriction[r] === null) {
                                                                        ...
                                                                        curFilterString = addRestriction(curFilterString, viewAttributeName + AppData.replaceOdataFilter(curRestriction[r]));
                                                                    }
                                                                }
                                                            } else {
                                                                curFilterString = addRestriction(curFilterString, "");
                                                                ...
                                                                for (j = 0; j < curRestriction.length; j++) {
                                                                    if (curRestriction[j]) {
                                                                        ...
                                                                        if (curRestriction[j] === "NULL") {
                                                                            ...
                                                                            curFilterString += viewAttributeName + AppData.replaceOdataFilter(curRestriction[j]);
                                                                        }
                                                                        hasRestriction = true;
                                                                    }
                                                                }
                                                            ...
                                                            if ((that.attribSpecs[i].Function & 16384) &&
                                                                ...
                                                                if (curRestriction === "NULL") {
																    ...
																    curFilterString = addRestriction(curFilterString, viewAttributeName + AppData.replaceOdataFilter(curRestriction));
                                                                }
                                                            }
                                                        }
                                                    }
