                                                ...
                                                if (typeof curRestriction !== "undefined" &&
                                                    ...
                                                    if (isString && !restriction.bExact) {
                                                        ...
                                                        if (typeof curRestriction === "object") {
                                                            if (restriction.bAndInEachRow) {
                                                                if (curRestriction.length > r) {
                                                                    ...
                                                                    if (curRestriction[r] === null) {
                                                                        ...
                                                                        curFilterString = addRestriction(curFilterString, "startswith(" + viewAttributeName + ",'" + encodeURI(curRestriction[r]) + "')");
                                                                    }
                                                                }
                                                            } else {
                                                                ...
                                                                for (j = 0; j < curRestriction.length; j++) {
                                                                    if (curRestriction[j]) {
                                                                        ...
                                                                        if (curRestriction[j] === "NULL") {
                                                                            ...
                                                                            curFilterString += "startswith(" + viewAttributeName + ",'" + encodeURI(curRestriction[j]) + "')";
                                                                        }
                                                                        hasRestriction = true;
                                                                    }
                                                                }
                                                            ...
                                                            curFilterString = addRestriction(curFilterString, "startswith(" + viewAttributeName + ",'" + encodeURI(curRestriction) + "')");
                                                        }
                                                        // for timestamp as atttribute type
