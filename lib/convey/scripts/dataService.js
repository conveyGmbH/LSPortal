...
(function () {
    ...
    WinJS.Namespace.define("AppData", {
        // formatViewData:
        //      general service for work relation data access
        //
        // Methods:
        //
        // select
        ...
        // lgntInitData
        //      general service for LGNTINIT (language init) relation data access
        //
        // Methods:
        //
        // select
        //      purpose:
        //          selects one or all records from language specific init table
        //
        //      params:
        //          complete: function(response) - success handler
        //          error: function(response) - error handler
        ...
        //      optional params
        //          recordId: integer - currently selected record (primary key)
        //          option: object - selection options
        //              option.ordered: boolean - true|false enables list order
        //              option.orderByValue: boolean - true|false ordering by ID (true) or TITLE (false)
        //              option.desc: boolean - true|false results in descending order
        //
        //      remark:
        //          uses $http only for GET requests
        //          this will return JSON data in response.data member!
        //
        //          for each LGNTINIT<relationName> table
        //          a 1:1 synonym view named LGNTINIT<relationName>_ODataVIEW is needed
        //          to ensure access to foreign key values as integer columns
        //
