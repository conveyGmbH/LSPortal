    ...
    WinJS.Namespace.define("Application", {
        ...
        PageFrame: WinJS.Class.define(
            ...
            function PageFrame(aName) {
                ...
                initLanguage: function (complete, error) {
                    Log.call(Log.l.trace, "PageFrame.", "");
                    ...
                    if (typeof navigator.globalization === "object") {
                        ...
                        if (AppData._persistentStates.languageId && !resources) {
                            var newLanguage = AppData.getLanguageFromId(AppData._persistentStates.languageId);
                            Application.language = newLanguage;
                            complete(Application.language);
                        } else {
                            language = window.navigator.userLanguage || window.navigator.language;
                            Application.language = repairLanguage(language);
                            complete(Application.language);
                        }
                    }
                    Log.ret(Log.l.trace);
                ...
                reCheckForLanguage: function (complete, error) {
                    Log.call(Log.l.trace, "PageFrame.", "");
                    if (AppData._persistentStates.prevLanguageId === AppData._persistentStates.languageId) {
                ...
                post_initialize: function () {
                    ...
                    var appBar = new AppBar.AppBarClass({ textColor: Colors.textColor });
                    ...
                    var navigationBar = new NavigationBar.ListViewClass(Application.navigationBarPages, Application.navigationBarGroups);
