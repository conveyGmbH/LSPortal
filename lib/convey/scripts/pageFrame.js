    ...
    WinJS.Namespace.define("Application", {
        ...
        PageFrame: WinJS.Class.define(
            ...
            function PageFrame(aName) {
                ...
                loadRemoteRessource: function (languageID, complete, error, pageName, isRegister) {
                    Log.call(Log.l.trace, "PageFrame.", "");
                ...
                loadLocalRessources: function (language, complete, error, loadRemoteRessource) {
                    Log.call(Log.l.trace, "PageFrame.", "");
                    ...
                    var ret = WinJS.xhr({ url: url }).then(function (res) {
                        ...
                        ret = Application.pageframe.loadRemoteRessource(AppData.getLanguageId(), function (result) {
                            // alert box feature
                            Application._initAlert();
                            complete(result);
                        }, function () {
                            Log.print(Log.l.error, "loadRemoteRessource failed");
                            var errorResponse = "Error: failed to load languagetext!";
                            error(errorResponse);
                        }, null, true);
                    });
                    Log.ret(Log.l.trace);
                ...
                checkForResources: function (language, complete, error) {
                    ...
                    Application.pageframe.loadLocalRessources(language, function (result) {
                        // alert box feature
                        Application._initAlert();
                        if (!AppData._persistentStates.loadRemoteRessource) {
                        complete();
                        }
                    }, function (err) {
                        Log.print(Log.l.error, "loadLocalRessources failed");
                        error();
                    }, AppData._persistentStates.loadRemoteRessource);
                    Log.ret(Log.l.trace);
                },
