            ...
            Controller: WinJS.Class.define(function Controller(pageElement, addPageData, commandList, isMaster) {
               ...
               */
                processAll: function () {
                                            ...
                                            if (rect &&
                                                ...
                                                while (target.parentElement !== that._element) {
                                                    if (target.dataset &&
                                                        ...
                                                        target.parentElement.parentElement.dataset &&
                                                        target.parentElement.parentElement.dataset.winControl === "WinJS.UI.ListView" &&
                                                        WinJS.Utilities.hasClass(target.parentElement, "win-viewport") &&
                                                        target.parentElement.clientWidth < target.clientWidth) {
                                                        that._hammerDisabled = true;
                    ...
                    if (!that.isMaster) {
                        that.initSwipeHandler = initSwipeHandler;
                        initSwipeHandler();
                    }
