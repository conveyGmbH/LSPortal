...
(function () {
    ...
    WinJS.Namespace.define("Fragments", {
         ...
         */
        RecordsetController: WinJS.Class.derive(Fragments.Controller, function RecordsetController(pageElement, addPageData, commandList, isMaster, tableView, showView, listView) {
