            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                if (Colors._prevIsDarkTheme !== null && Colors._prevIsDarkTheme === Colors.isDarkTheme) {
                    ...
                    if (Colors.isDarkTheme) {
                        ...
                        if (WinJS.Utilities.hasClass(document.body, "win-ui-light")) {
                            WinJS.Utilities.removeClass(document.body, "win-ui-light");
                        }
                        if (!WinJS.Utilities.hasClass(document.body, "win-ui-dark")) {
                            WinJS.Utilities.addClass(document.body, "win-ui-dark");
                        }
                    } else {
                        Colors.loadCSSfile("lib/WinJS/css/ui-light.min.css");
                        if (WinJS.Utilities.hasClass(document.body, "win-ui-dark")) {
                            WinJS.Utilities.removeClass(document.body, "win-ui-dark");
                        }
                        if (!WinJS.Utilities.hasClass(document.body, "win-ui-light")) {
                            WinJS.Utilities.addClass(document.body, "win-ui-light");
                        }
                    }
