...
(function () {
    ...
    WinJS.Namespace.define("Colors", {
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                WinJS.Promise.timeout(500).then(function () {
                    ...
                    if (AppData._persistentStates.inputBorderBottom) {
                        ...
                        Colors.changeCSS(".field_line", "border-bottom-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                    }
                    Colors.changeCSS(".row-separator", "border-top-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                    Colors.changeCSS(".window-color", "color", Colors.isDarkTheme ? "#ffffff" : "#000000");
                    Colors.changeCSS("#navigationbar_vertical.win-listview", "border-right-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                    Colors.changeCSS(".win-listview#navigationbar_vertical", "border-right-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                    Colors.changeCSS(".centerarea", "border-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                ...
                if (typeof colorSettings.textColor != "undefined" &&
                    ...
                    var textColorRgb = Colors.hsv2rgb(
                        (hsv.h + 196) % 360, hsv.s * 0.24, Colors.isDarkTheme ? 76 : 44
                    );
                ...
                if (typeof colorSettings.backgroundColor != "undefined" &&
                    ...
                    var backgroundColorRgb = Colors.hsv2rgb(
                        (hsv.h + 196) % 360,
                        Colors.isDarkTheme ? 90 : 3,
                        Colors.isDarkTheme ? 10 : 100
                    );
                ...
                if (typeof colorSettings.tileTextColor != "undefined" &&
                    ...
                    var tileTextColorRgb = Colors.hsv2rgb(
                        (hsv.h + 196) % 360, hsv.s * 0.24, Colors.isDarkTheme ? 84 : 22
                    );
                ...
                if (Colors._prevInputBorderBottom === AppData._persistentStates.inputBorderBottom &&
                    ...
                    WinJS.Promise.timeout(500).then(function () {
                        if (AppData._persistentStates.inputBorderBottom) {
                            ...
                            Colors.changeCSS(".win-textarea, .win-textbox", "padding", "3px 0 5px 0");
                            ...
                            Colors.changeCSS("span.input_field, span.input_small_right, span.input_small_left, span.input_threequarter_left, span.input_quarter_right",
                                "border-bottom-color", Colors.isDarkTheme ? "#404040" : "#e6e6e6");
                        } else {
                            Colors.changeCSS("input.win-textbox, textarea.win-textarea",
                                "border-width", AppData._persistentStates.inputBorder + "px");
                            Colors.changeCSS(".win-textarea, .win-textbox", "padding", "3px 6px 5px 10px");
                            Colors.changeCSS("span.input_field, span.input_small_right, span.input_small_left, span.input_threequarter_left, span.input_quarter_right",
        ...
        changeSVGStroke: function(svgRoot, strokeWidth, color) {
            if (svgRoot) {
                var curWidth;
                        ...
                        if (svgObject) {
                            ...
                            if (svgRoot) {
                                ...
                                if (typeof strokeWidth !== "undefined") {
                                    Colors.changeSVGStroke(svgRoot, strokeWidth, color);
                                }
                ...
                if (newElementList && newElementList.length > 0) {
                    for (var i = 0; i < newElementList.length; i++) {
                        ...
                        if (id && id.length > 0 && id.substr(0, 2) !== "{{") {
                            ...
                            if (svgParentElement && !(svgParentElement.firstElementChild || svgParentElement.firstChild)) {
