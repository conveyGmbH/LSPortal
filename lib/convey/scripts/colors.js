...
(function () {
    ...
    WinJS.Namespace.define("Colors", {
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                this._loadCssPromise = loadCssPromise.then(function() {
                    WinJS.Promise.timeout(50).then(function () {
                        if (root && root.style) {
                            root.style.setProperty("--ColorAccentDefault", Colors.accentColor)
                        }
                    ...
                    if (Colors._prevNavigationColor === that._navigationColor &&
                        ...
                        WinJS.Promise.timeout(50).then(function () {
                            if (root && root.style) {
                                root.style.setProperty("--ColorNavigationDefault", Colors.navigationColor)
                            }
        ...
        */
        ...
        tileBorderColor: {
            get: function () {
                return Colors._colorsClass && Colors._colorsClass._tileBorderColor;
            }
        },
        newColor: {
            get: function () {
