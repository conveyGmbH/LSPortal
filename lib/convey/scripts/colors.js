            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                if (typeof colorSettings.navigationColor != "undefined" &&
                    ...
                    if (!Colors.isDarkTheme) {
                        ...
                        navigationColorRgb = Colors.hex2rgb(colorSettings.navigationColor);
                ...
                var selectionBackgroundColorRgb;
                if (typeof colorSettings.selectionBackgroundColor != "undefined" &&
                    colorSettings.selectionBackgroundColor) {
                    if (!Colors.isDarkTheme) {
                        this._selectionBackgroundColor = colorSettings.selectionBackgroundColor;
                    } else {
                        selectionBackgroundColorRgb = Colors.hex2rgb(colorSettings.selectionBackgroundColor);
                        var hsvSelectionBackgroundColor = Colors.rgb2hsv(selectionBackgroundColorRgb);
                        selectionBackgroundColorRgb = Colors.hsv2rgb(
                            hsvSelectionBackgroundColor.h,
                            hsvSelectionBackgroundColor.s,
                            100 - hsvSelectionBackgroundColor.v
                        );
                        this._selectionBackgroundColor = Colors.rgb2hex(selectionBackgroundColorRgb.r, selectionBackgroundColorRgb.g, selectionBackgroundColorRgb.b);
                    }
                } else {
                ...
                if (typeof colorSettings.masterHostBackgroundColor != "undefined" &&
                    ...
                    if (!Colors.isDarkTheme) {
                        ...
                        masterHostBackgroundColorRgb = Colors.hex2rgb(colorSettings.masterHostBackgroundColor);
                ...
                this._loadCssPromise = loadCssPromise.then(function() {
                    ...
                    Colors._prevMasterHostBackgroundColor = that._masterHostBackgroundColor;
        ...
        updateColors: function () {
            ...
            if (Colors._colorsClass &&
                (Colors._prevAccentColor !== Colors._colorsClass._accentColor ||
                 ...
                 Colors._prevMasterHostBackgroundColor !== Colors._colorsClass._masterHostBackgroundColor ||
                ...
                if (!AppData._persistentStates.individualColors) {
                    ...
                    colorSettings = {
                        ...
                        masterHostBackgroundColor: Colors._colorsClass._masterHostBackgroundColor,
                        ...
                        dashboardColor:
                            Colors._colorsClass._dashboardColor ||
                                Colors._colorsClass._navigationColor //similar to navigationColor
                    };
                }
                ...
                promise.then(function() {
                    ...
                    AppData._persistentStates.colorSettings.masterHostBackgroundColor = Colors.masterHostBackgroundColor;
