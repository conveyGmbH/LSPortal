    ...
    WinJS.Namespace.define("Colors", {
        ...
        ColorsClass: WinJS.Class.define(
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                var rgbNavigationColor = Colors.hex2rgb(Colors.navigationColor);
                ...
                this._navigationColorSelected = Colors.rgb2hex(navigationColorRgb.r, navigationColorRgb.g, navigationColorRgb.b);
        ...
        accentColor: {
            ...
            set: function(color) {
                ...
                if (Colors._colorsClass &&
                    ...
                    Colors._colorsClass._navigationColorSelected = null;
