...
(function () {
    ...
    WinJS.Namespace.define("Colors", {
        ...
        adjustColorForTheme: function (color, isBackground) {
            ...
            if (hsvColor.v > 50 && grayVal > 160 && (isBackground && Colors.isDarkTheme || !isBackground && !Colors.isDarkTheme) ||
                hsvColor.v < 50 && grayVal < 96 && (!isBackground && Colors.isDarkTheme || isBackground && !Colors.isDarkTheme)) {
        ...
        ColorsClass: WinJS.Class.define(
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                textColor: {
                    ...
                    set: function (color) {
                        this._textColorColorInitial = color;
