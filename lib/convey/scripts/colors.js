            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                if (typeof colorSettings.navigationColor != "undefined" &&
                    ...
                    var navigationColorRgb = Colors.hsv2rgb(
                        this._hsv.h,
                        this._hsv.s = Colors.isDarkTheme ? Math.min(100, this._hsv.s * 1.15) : this._hsv.s * 0.7,
                        this._hsv.v = Colors.isDarkTheme ? Math.min(100, this._hsv.v * 1.33) : this._hsv.v * 0.85
                    );
