...
(function () {
    ...
    WinJS.Namespace.define("Colors", {
                ...
                this._loadCssPromise = loadCssPromise.then(function() {
                    ...
                    if (Colors._prevInputBorderBottom === AppData._persistentStates.inputBorderBottom &&
                        ...
                        WinJS.Promise.timeout(50).then(function () {
                            ...
                            if (AppData._persistentStates.inputBorderRadius) {
                                Colors.changeCSS(".use-border-radius", "border-radius", (AppData._persistentStates.inputBorderRadius * 4) + "px");
                                Colors.changeCSS(".use-border-radius", "padding", (AppData._persistentStates.inputBorderRadius * 4) + "px !important");
                                if (!AppData._persistentStates.inputBorderBottom) {
                                ...
                                Colors.changeCSS(".centerarea", "border-radius", (AppData._persistentStates.inputBorderRadius * 4) + "px");
                            }
                    ...
                    if (Colors._prevNavigationColor === that._navigationColor &&
                        ...
                        WinJS.Promise.timeout(50).then(function () {
                            ...
                            if (Colors.isDarkTheme) {
                                rgb = Colors.hsv2rgb(hsv.h, hsv.s * 0.8, hsv.v * 0.65);
                            } else {
                                rgb = Colors.hsv2rgb(hsv.h, hsv.s * 0.6, Math.min(100, hsv.v * 1.1));
                            }
                            Colors.changeCSS(".win-selected .onsite-offsite, .win-selected .list-symbol-addon", "border-color",
        ...
        */
        ...
        newColor: {
            get: function () { return Colors._colorsClass && Colors._colorsClass._newColor; }
        },
        onColor: {
            get: function () { return Colors._colorsClass && Colors._colorsClass._onColor; }
        },
        pauseColor: {
            get: function () { return Colors._colorsClass && Colors._colorsClass._pauseColor; }
        },
        offColor: {
            get: function () { return Colors._colorsClass && Colors._colorsClass._offColor; }
        },
        unknownColor: {
            get: function () { return Colors._colorsClass && Colors._colorsClass._unknownColor; }
        },
        /**
