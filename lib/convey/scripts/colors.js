        ...
        ColorsClass: WinJS.Class.define(
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                WinJS.Promise.timeout(500).then(function () {
                    ...
                    Colors.changeCSS(".field_line", "border-top-color", Colors.isDarkTheme ? "#202020" : "#e8e8e8");
                    Colors.changeCSS(".row-separator", "border-top-color", Colors.isDarkTheme ? "#202020" : "#e8e8e8");
                ...
                if (Colors._prevInputBorderRadius === AppData._persistentStates.inputBorderRadius &&
