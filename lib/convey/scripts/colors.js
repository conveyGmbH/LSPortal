        ...
        loadCSSfile: function (filename) {
            ...
            if (!Colors.corsAwareCssRuleAccess) {
                ...
                if (heads && heads[0]) {
                    ...
                    var prevRef = document.querySelectorAll("link[href=\"" + filename + "\"")[0];
                    heads[0].appendChild(fileRef);
                    if (prevRef) {
                        heads[0].removeChild(prevRef);
                    } 
                }
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                if (Colors._prevIsDarkTheme !== null && Colors._prevIsDarkTheme === Colors.isDarkTheme) {
                    ...
                    if (Colors.isDarkTheme) {
                        loadCssPromise = Colors.loadCSSfile("lib/WinJS/css/ui-dark.min.css");
                        ...
                        loadCssPromise = Colors.loadCSSfile("lib/WinJS/css/ui-light.min.css");
                        if (WinJS.Utilities.hasClass(document.body, "cnv-ui-dark")) {
