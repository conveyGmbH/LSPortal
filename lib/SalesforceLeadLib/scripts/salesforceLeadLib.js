...
(function() {
    ...
    class SalesforceLeadLib {
                    ...
                    <div class="contenthost-background sf-fieldmap-root">
                        <div style="flex: 1; display: flex; flex-direction: column; overflow: hidden;">
                            <header class="sf-fieldmap-header">
                                <div style="flex: 1; min-width: 260px;">
                                    <h1><i class="${_providerIconClass(providerConfig.apiEndpointValue)}" aria-hidden="true"></i> Field Configurator — ${providerConfig.providerLabel}</h1>
                                    <p id="event-info" class="sf-fieldmap-desc">Configure which fields will be transferred to ${providerConfig.providerLabel} for this event. Required fields (LastName, Company) are always included.</p>
                                </div>
                                <div class="sf-fieldmap-actions">
                        ...
                        <label class="field-item sf-fieldmap-card${isRequired ? ' required' : ''}${isActive ? ' active' : ''}${isCustom ? ' user-custom-field' : ''}"
                            ...
                            <div class="field-info" style="flex: 1; min-width: 0;">
                                ...
                                ` : `
                                    ...
                                    ${field.hasCustomLabel && field.customLabel !== field.name ? `<div class="sf-fieldmap-card__mapping"><i class="fa-solid fa-arrow-right-long" aria-hidden="true" style="font-size: 10px; margin-right: 4px;"></i>${targetLabel}: ${field.customLabel}</div>` : ''}
                                `}
                            </div>
                            ${isCustom ? `
        ...
        static async _refreshConnectionStatusInSettings(rootElement, crmAdapter) {
            ...
            if (indicator) { indicator.classList.toggle('sf-dot--success', connected); indicator.classList.toggle('sf-dot--warning', !connected); }
