            ...
            try {
                ...
                rootElement.innerHTML = `
                    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 60px 20px; min-height: 300px;">
                        ...
                        <p style="margin-top: 16px; font-size: 15px; color: var(--sf-text-2); font-family: var(--sf-font);" data-win-res="{textContent: 'crmSettings.loadingFields'}">Loading fields...</p>
                    </div>
                `;
