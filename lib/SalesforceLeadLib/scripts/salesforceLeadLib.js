    ...
    class SalesforceLeadLib {
                    ...
                    <div class="contenthost-background sf-fieldmap-root">
                        <div style="flex: 1; display: flex; flex-direction: column; overflow: hidden;">
                            <header class="sf-fieldmap-header">
                                <div style="flex: 1; min-width: 260px;">
                                    <h1>Field Configurator — ${providerConfig.providerLabel}</h1>
                                ...
                                <div class="sf-fieldmap-actions">
                                    ...
                                    <button id="sf-connect-btn" class="sf-btn sf-btn--primary">
                                        <i class="fa-solid fa-plug" aria-hidden="true"></i> <span>Connect to ${providerConfig.providerLabel}</span>
                                    </button>
        ...
        static async renderContactList(rootElement, eventId, options = {}) {
            ...
            const providerConfig = {
                ...
                dataCache: options.dataCache || null,
                crmAdapter: options.crmAdapter || null,
                // Batch transfer (executeBatchTransfer -> buildLeadDataFromItem ->
                // transferSingleLead) is Salesforce Lead-object/__c-suffix/
                // /api/salesforce/leads specific and not generalized yet — a
                // provider without real transfer support disables the button
                // instead of hiding the rest of this rich UI (filters/search/
                // sort/connect all still work).
            ...
            try {
                ...
                const sfBtnHtml = `
                    <div class="sf-cl-status-wrap">
                        ...
                        <button id="sf-cl-connect-btn" class="sf-cl-btn-connect" style="display:${sfStatus.connected ? 'none' : 'flex'};">Connect ${esc(providerConfig.providerLabel)}</button>
                    </div>`;
