    ...
    `;
        ...
        static async openCrmTestExport(rootElement, eventId) {
            ...
            try {
                ...
                // Load data from LS_LeadReport endpoint with EventId filter (much faster)
                ...
                if (rawLeadData) {
                    ...
                    console.log('No contacts found for event, using default field structure for preview');
