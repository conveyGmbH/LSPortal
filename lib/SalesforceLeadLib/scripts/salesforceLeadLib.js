    ...
    class SalesforceLeadLib {
        ...
        static async renderContactList(rootElement, eventId, options = {}) {
            ...
            try {
                ...
                const crmBadgeHtml = `
                    <span class="sf-cl-crm-badge" title="${_t('crmExport.currentCrm', 'Current CRM')}: ${esc(providerConfig.providerLabel)}">
                ...
                rootElement.innerHTML = `
                    <div class="sf-cl-wrap">
                        <div class="sf-cl-toolbar">
                            ...
                            ${providerConfig.duplicateCheckAdapter ? `<button class="sf-cl-btn sf-cl-btn-dupcheck" id="sf-cl-dupcheck-btn" disabled><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i> ${_t('crmExport.checkDuplicates', 'Check Duplicates')}</button>` : ''}
                            ...
                            <div class="sf-cl-status-filter" id="sf-cl-status-filter">
                                ...
                                ${providerConfig.duplicateCheckAdapter ? `<button class="sf-cl-status-pill pill-alreadyin" id="sf-cl-pill-alreadyin" data-status="__alreadyin" style="display:none;">${_t('crmExport.filterAlreadyIn', 'Already in {0}').replace('{0}', esc(providerConfig.providerLabel))} <span id="sf-cl-pill-alreadyin-count"></span></button>` : ''}
                                ${providerConfig.duplicateCheckAdapter ? `<button class="sf-cl-status-pill pill-emailconflict" id="sf-cl-pill-emailconflict" data-status="__emailconflict" style="display:none;">${_t('crmExport.filterEmailConflict', 'Email conflict')} <span id="sf-cl-pill-emailconflict-count"></span></button>` : ''}
                        ...
                        <div class="sf-cl-dupcheck-bar" id="sf-cl-dupcheck-bar" style="display:none;">
                            <label class="sf-cl-dupcheck-exclude">
                            ...
                            <table class="sf-cl-table" id="sf-cl-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sf-cl-th" style="width:40px;text-align:center;"></th>
                ...
                const renderRows = (items) => {
                    ...
                    tbody.innerHTML = items.map(item => {
                        ...
                        const editCell = item.KontaktViewId
                            ? `<td class="sf-cl-td" style="text-align:center;"><button class="sf-cl-edit-btn" data-kontakt-view-id="${esc(item.KontaktViewId)}" title="${_t('crmExport.editContact', 'Edit')}" aria-label="${_t('crmExport.editContact', 'Edit')}"><i class="fa-solid fa-pen" aria-hidden="true"></i></button></td>`
                            : `<td class="sf-cl-td"></td>`;
                ...
                // Edit-contact button click (delegated) — jumps straight to
                // the app's own Edit Contact page (pages/contact/) for this
                // row's lead, same navigation the Preview & Validate modal's
                // own "Edit" link uses.
                rootElement.querySelector('#sf-cl-tbody').addEventListener('click', (e) => {
