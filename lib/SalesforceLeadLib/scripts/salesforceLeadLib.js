...
(function() {
    ...
    class SalesforceLeadLib {
                    ...
                    <div class="sf-cl-wrap">
                        <div class="sf-cl-toolbar">
                            ...
                            <div class="sf-cl-status-filter" id="sf-cl-status-filter">
                                ...
                                <span style="width:1px;height:16px;background:var(--ColorLabel);margin:0 6px;display:inline-block;opacity:0.4;"></span>
                                <select id="sf-cl-completeness-select" style="font-size:12px;font-weight:600;padding:3px 8px;border-radius:8px;border:1px solid var(--ColorLabel);background:var(--ColorTileBackground);color:var(--ColorText);cursor:pointer;">
        ...
        static async _sfDisconnect() {
            ...
            ['sf_session_token', 'sf_access_token', 'sf_instance_url', 'sf_refresh_token', 'sf_connection_status', 'sf_user_info'].forEach(k => localStorage.removeItem(k));
        }
