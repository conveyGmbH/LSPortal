...
(function() {
    ...
    function formatErrorMessage(message) {
        ...
        // Pattern 1: "FieldName: error message: value"
        // Example: "Email: invalid email address: ^Ajtojl:schwaab@convey.de"
        ...
        // Pattern 2: "FieldName: error message" (without value)
        ...
        // Pattern 3: Multiple fields in one line separated by commas
        ...
        static _renderFieldsGrid(rootElement, fieldMappingService, currentFilter) {
            ...
            const allFields = standardFields.map(sf => {
                ...
                return {
                    ...
                    active: config ? config.active !== false : true, // Default to active if no config
