            ...
            try {
                ...
                rootElement.innerHTML = `
                    <style>
                        ...
                        .sf-cl-status-pill { height:38px; padding:0 14px; border-radius:19px; font-size:12px; font-weight:600; cursor:pointer; border:1px solid var(--ColorLabel); background:var(--ColorTileBackground); color:var(--ColorText); transition:background .15s,color .15s,border-color .15s; white-space:nowrap; display:inline-flex; align-items:center; justify-content:center; box-sizing:border-box; }
                        ...
                        /* Attachment badge */
                        .sf-cl-attach-badge { display:inline-flex; align-items:center; gap:3px; padding:2px 7px; border-radius:10px; font-size:12px; font-weight:600; background:var(--ColorTileBackground); color:var(--ColorText); border:1px solid var(--ColorLabel); cursor:pointer; transition:background .15s,color .15s; }
                    ...
                    <div class="sf-cl-wrap">
                        <div class="sf-cl-toolbar">
                            ...
                            <div class="sf-cl-status-filter" id="sf-cl-status-filter">
                                ...
                                <select id="sf-cl-completeness-select" style="height:38px;font-size:12px;font-weight:600;padding:0 10px;border-radius:8px;border:1px solid var(--ColorLabel);background:var(--ColorTileBackground);color:var(--ColorText);cursor:pointer;box-sizing:border-box;">
