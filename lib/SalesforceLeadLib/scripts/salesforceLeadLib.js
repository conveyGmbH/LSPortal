...
(function() {
    ...
    // Only core contact/address fields are active by default.
    // Fields like Industry, AnnualRevenue, etc. can be activated via the Field Configurator.
            ...
            if (Object.keys(apiFields).length === 0) {
                for (const fieldName in standardSalesforceFields) {
                    if (!processedFields.has(fieldName)) {
                        ...
                        let isActive = config ? config.active !== false : false;
