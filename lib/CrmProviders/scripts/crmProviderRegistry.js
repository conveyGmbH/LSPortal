...
(function () {
    ...
    // True once the client has gone through CRM Connections and explicitly
    // picked/switched a provider. Existing Salesforce clients that predate
    // the multi-CRM catalog have never done this — crmExport/crmSettings use
    // this to skip the real checkConnection() gate for them and keep their
    // pre-existing behavior unchanged (see those controllers' loadData()).
