...
(function () {
    ...
    function closeAllModals() {
        ...
        function getCurrentPassword(){
            return currentSession.currentPassword || 'fallback-password'; 
        }
            ...
            if (devices.devices && devices.devices.length > 0) {
                ...
                devicesHtml += `
                    <div style="text-align: center; padding: 40px; border: 1px solid #ddd; border-radius: 8px;">
                        ...
                        <button id="tfa-enable-empty-btn" class="tfa-btn-primary" style="padding: 12px 24px;">
                            🛡️ Enable 2FA
                        </button>
                    </div>
                `;
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        if (verifyResult.success) {
                            ...
                            showSuccess(`Device "${deviceName}" has been successfully added!`);
    ...
    let TwoFactorLib = {
        ...
        getStatus: function (root, username, password, setTokenPassword, language, hostName) {
            ...
            const promise = (async () => {
                try {
                    ...
                    console.log("getstatus password", password)
                    ...
                    return new Promise((resolve, reject) => {
                        ...
                        verifyForm.onsubmit = async (e) => {
                            ...
                            try {
                                ...
                                console.log("result verify - 2FA", result);
                                 console.log("api password 2FA", password);
                                ...
                                if (result.success) {
                                    ...
                                    if (typeof setTokenPassword === 'function' && result.dbPassword) {
                                        ...
                                        console.log('setTokenPassword', setTokenPassword(result.dbPassword));
        ...
        disable2FA: async function (username, currentPassword) {
            try {
                ...
                console.log("START username", username , "currentPassword", currentPassword);
                ...
                if (result.success) {
                    ...
                    const passwordToUse = result.originalPassword ||  result.data?.originalPassword ||  currentPassword;
                     console.log('Password used:', passwordToUse);
        ...
        removeDevice: async function (deviceId, deviceName, username, currentPassword) {
            try {
                console.log('🗑️ Starting device removal:', { deviceId, deviceName, username });
                 ...
                 let isLastDevice = false;
                  ...
                  try {
                        ...
                        console.log("removeDevice password", currentPassword)
                ...
                console.log("removeDevice result", result)
        ...
        showRemoveDeviceModal: function(deviceId, deviceName, username, currentPassword, isLastDevice = false) {
            return new Promise((resolve, reject) => {
                ...
                form.onsubmit = async (e) => {
                    ...
                    console.log("showRemoveDeviceModal passwordInput", originalPassword)
                    ...
                    try {
                        ...
                        console.log("showRemoveDeviceModal password", password);
                        console.log("showRemoveDeviceModal original password", originalPassword)
                        console.log("showRemoveDeviceModal result", result)
        ...
        showDisable2FAModal: function(username, currentPassword) {
            return new Promise((resolve, reject) => {
                ...
                form.onsubmit = async (e) => {
                    ...
                    console.log("password enter", originalPassword);
                    ...
                    try {
                        ...
                        console.log("originalPassword result", originalPassword)

                        console.log("Show2FAModal result", result)
