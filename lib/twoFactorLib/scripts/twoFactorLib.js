        ...
        removeDevice: async function (deviceId, deviceName, username, currentPassword) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    console.log("Last device removed - 2FA disabled, updating password");

                    const newPassword = result.currentPassword || currentPassword;

                    if (typeof currentSession.setPasswordCallback === "function") {
                        currentSession.setPasswordCallback(newPassword);
                        console.log("Password updated to original via callback");
                    }
                                ...
                                try {
                                    ...
                                    if (confirmResult.success) {
                                        ...
                                        resolve({
                                            ...
                                            data: confirmResult,
                                            twoFactorDisabled: confirmResult.twoFactorDisabled || true,
                                            currentPassword: confirmResult.currentPassword
                                        });
                                    }
                                } catch (confirmError) {
