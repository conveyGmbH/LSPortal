...
(function () {
    ...
    function getResourceText(key) {
        // Use the global LeadSuccess function to retrieve texts
                ...
                setupContent.innerHTML = `
                    <div style="text-align: center;">
                        <div style="padding: 16px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); margin-bottom: 20px;">
                            <img src="${result.totpSetup.qrCodeDataURL}" alt="${getResourceText('tfa.infoQrCodeAlt')} style="max-width: 200px; height: auto;">
                        </div>
                                ...
                                <div class="tfa-modal" style="max-width: 400px;">
                                    <div style="padding: 30px;">
                                        <div style="text-align: center; margin-bottom: 20px;">
                                            ...
                                            <h3 style="margin: 0;">${getResourceText('tfa.title')}</h3>
                                            <p style="margin: 10px 0 0 0; color: #666; font-size: 14px;">
                                                ${getResourceText('tfa.verifyInstruction')}
                                            </p>
                                        </div>
            ...
            try {
                ...
                if (result.success) {
                    ...
                    if (typeof currentSession.setPasswordCallback === 'function') {
                        ...
                        console.log('Notified app of password change');
                    }
                                ...
                                <form id="tfa-remove-device-form">
                                    <div class="tfa-form-group">
                                        ...
                                        <input type="password" id="tfa-remove-password" class="tfa-form-input" 
                                            placeholder="${getResourceText('tfa.originalPasswordLabel')}" required>
                                    </div>
